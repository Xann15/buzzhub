...
<body>
    ...
    <div class="upload-img mb-5 pb-3" id="upload-content">
        ...
        <p class="text-muted text-center">upload a story less than 25MB.</p>
        <form action="" method="post" enctype="multipart/form-data">
            <img src="" id="prev-image" class="d-block w-100" alt="">
            <video src="" id="prev-media" autoplay loop class="img-thumbnail d-block mx-auto"></video>

            <div class="container">
                <input type="file" onchange="readURL(this)" name="media" id="media" class="form-control mt-2">
